---
name: speckit-axi-review
description: Open a feature's spec-kit markdown in a browser review surface, collect
  the reviewer's annotations and comments, then apply the queued feedback to the files.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: axi:commands/speckit.axi.review.md
---
