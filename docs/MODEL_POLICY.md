...
|---|---|---|
| `ticket-research` | Gather | `haiku` |
| `ticket-research` | Analyze | `sonnet` |
| `ticket-research` | Escalate (conditional) | `opus` |
| `backlog-audit` | Scope | `sonnet` |
| `backlog-audit` | Audit | `sonnet` |
| `backlog-audit` | Escalate (conditional) | `opus` |
